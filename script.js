// This file uses JSX and requires Babel to be included in the HTML file.
...
const App = () => {
    ...
    // Specific activities, times, and locations provided by the user.
    // The date is used as a key in the format "M-D-YYYY".
    const activitiesData = {
    // Existing August Activities
    "8-6-2025": { name: "Lawn Games", time: "7:00 PM", where: "Stake Center", eventLabel: "Teacher's & Deacon's Quorum" },
    "8-13-2025": { name: "Water Games", time: "", where: "", eventLabel: "Combined YM" },
    "8-20-2025": { name: "", time: "", where: "", eventLabel: "Combined YM/YW" },
    "8-22-2025": { name: "Lava Hot Springs", time: "5:00 PM", where: "Stake Center", eventLabel: "Campout" },
    "8-27-2025": { name: "", time: "", where: "", eventLabel: "Teacher's & Deacon's Quorum" },
    // Existing September Activities
    "9-3-2025": { name: "Family Search Escape Room", time: "7:00 PM", where: "Family History Center", eventLabel: "Combined YM" },
    "9-5-2025": { name: "Rifle and Shotgun Shooting", time: "5:00 PM", where: "Stake Center", eventLabel: "Campout" },
    "9-10-2025": { name: "Outdoor Games", time: "7:00 PM", where: "Local Park", eventLabel: "Combined YM/YW" },
    "9-17-2025": { name: "", time: "", where: "", eventLabel: "Teacher's & Deacon's Quorum" },
    "9-24-2025": { name: "Hike", time: "6:00 PM", where: "Mountain Trailhead", eventLabel: "Combined YM/YW" },
    // New Wednesday activities with TBD placeholders
    "10-1-2025": { name: "TBD", time: "TBD", where: "TBD", eventLabel: "Combined YM/YW" },
    "10-8-2025": { name: "TBD", time: "TBD", where: "TBD", eventLabel: "Combined YM/YW" },
    "10-15-2025": { name: "TBD", time: "TBD", where: "TBD", eventLabel: "Combined YM/YW" },
    "10-22-2025": { name: "TBD", time: "TBD", where: "TBD", eventLabel: "Combined YM/YW" },
    "10-29-2025": { name: "TBD", time: "TBD", where: "TBD", eventLabel: "Combined YM/YW" },
    "11-5-2025": { name: "TBD", time: "TBD", where: "TBD", eventLabel: "Combined YM/YW" },
    "11-12-2025": { name: "TBD", time: "TBD", where: "TBD", eventLabel: "Combined YM/YW" },
    "11-19-2025": { name: "TBD", time: "TBD", where: "TBD", eventLabel: "Combined YM/YW" },
    "11-26-2025": { name: "TBD", time: "TBD", where: "TBD", eventLabel: "Combined YM/YW" },
    "12-3-2025": { name: "TBD", time: "TBD", where: "TBD", eventLabel: "Combined YM/YW" },
    "12-10-2025": { name: "TBD", time: "TBD", where: "TBD", eventLabel: "Combined YM/YW" },
    "12-17-2025": { name: "TBD", time: "TBD", where: "TBD", eventLabel: "Combined YM/YW" },
    "12-24-2025": { name: "TBD", time: "TBD", where: "TBD", eventLabel: "Combined YM/YW" },
    "12-31-2025": { name: "TBD", time: "TBD", where: "TBD", eventLabel: "Combined YM/YW" },
    };
